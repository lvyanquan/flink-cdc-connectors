...
public class TransformDataFunction extends AbstractStreamOperator<Event>
    ...
    public static TransformDataFunction.Builder newBuilder() {
        return new TransformDataFunction.Builder();
    }

    /** Builder of {@link TransformDataFunction}. */
    public static class Builder {
        private final List<Tuple3<String, String, String>> transformRules = new ArrayList<>();

        public TransformDataFunction.Builder addTransform(
                String tableInclusions, String projection, String filter) {
            transformRules.add(Tuple3.of(tableInclusions, projection, filter));
            return this;
        }

        public TransformDataFunction build() {
            return new TransformDataFunction(transformRules);
        }
    }

    private TransformDataFunction(List<Tuple3<String, String, String>> transformRules) {
